	...
	<body>
		<div>
		   ...
		   <table>
		    ...
		    <!-- <모양 -->
		      <c:if test="${page>1}">
		      <a href="bList.do?page=${page-1}"><span><i class="fa fa-angle-left" aria-hidden="true"></i></span></a>
		      </c:if>
		      <c:if test="${page==1}">
		     ...
		     <span class="on">${p}</span>
		      ...
		      <c:if test="${page != p }">
		      <a href="bList.do?page=${p}"><span>${p}</span></a>
		      </c:if>
		      </c:forEach>
		      
		      <!-- >모양 -->
		      <c:if test="${page<maxPage }">
		      <a href="bList.do?page=${page+1}"><span><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
		      </c:if>
		      <c:if test="${page==maxPage }">
		      ...
		      <!-- >>모양 -->
		      <c:if test="${ page < maxPage}">
		      <a href="bList.do?page=${maxPage}"><span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span></a>
		      </c:if>
		      <c:if test="${ page == maxPage}">
