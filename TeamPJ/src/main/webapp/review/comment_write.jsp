						...
						<table class="checkTable" border="3" cellspacing="0">
							...
							<tbody>
								...
								<tr>
									...
									<td >
									<textarea class="tta" cols="500" rows="10" placeholder="의견을 입력하세요..." style="overflow-y: scroll; overflow-x: hidden;" required></textarea>
									</td>
								</tr>
								<tr class="ktag">
								...
								<tr>
									...
									<td>
										<button class="st_file" name="bfileFrm" >파일첨부</button>
									</td>
								</tr>								
							</tbody>
						</table>
